...
from custom.icds_reports.models import (
    ...
    CcsRecordMonthly,
    UcrTableNameMapping)
from custom.icds_reports.models.aggregate import AggregateInactiveAWW, DailyAttendance, AggAwc, AggAwcDaily
...
def move_ucr_data_into_aggregation_tables(date=None, intervals=2):
    ...
    if db_alias:
        ...
        for monthly_date in monthly_dates:
            ...
            res_child = chain(
                icds_aggregation_task.si(date=monthly_date, func=_child_health_monthly_table),
...
def _child_health_monthly_table(day):
    with transaction.atomic():
        ...
        # ], day)
        ChildHealthMonthly.aggregate(day)
